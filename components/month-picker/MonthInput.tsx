...
export function MonthInput(props: any) {
  ...
  return (
    <button className={styles.monthInputField} onClick={() => props.setShowMonthPicker(!props.showMonthPicker)}>
      {props.selected.monthName ?? new Date().toLocaleString(props.lang, { month: 'long' })} {props.selected.year}
      <svg
